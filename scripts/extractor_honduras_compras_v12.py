#!/usr/bin/env python3
"""
Extractor v12 - v5 mejorado + 16 instituciones completas
Incluye: 15 CORE + Distrito Central + PRONADERS + SESAL (3 nuevas)
Extrae licitaciones y compras menores preservando modalidad
"""
...
class SICCExtractorV12:
    """Extractor v12 - 16 instituciones (CORE + Distrito Central + PRONADERS + SESAL)"""
    ...
    def __init__(self):
        ...
        self.institution_map = {
            ...
            "27": ("Secretaría de Salud (SESAL)", "SESAL"),
            # Instituto (1)
            "493": ("Instituto Hondureño de Turismo (IHT)", "IHT"),
            # Municipalidades (7)
            "104": ("Municipalidad del Distrito Central", "DISTRITO CENTRAL"),
